...
if("TRUE" STREQUAL "TRUE")
  set(ublox_msgs_SOURCE_PREFIX /home/husai/catkin_ws/src/ublox/ublox_msgs)
  set(ublox_msgs_DEVEL_PREFIX /home/husai/catkin_ws/devel)
  ...
  set(ublox_msgs_INSTALL_PREFIX /home/husai/catkin_ws/install)
...
if(NOT "/home/husai/catkin_ws/devel/include;/home/husai/catkin_ws/src/ublox/ublox_msgs/include " STREQUAL " ")
  set(ublox_msgs_INCLUDE_DIRS "")
  set(_include_dirs "/home/husai/catkin_ws/devel/include;/home/husai/catkin_ws/src/ublox/ublox_msgs/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'ublox_msgs' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Veronica Lane <vmlane@alum.mit.edu>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'ublox_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/husai/catkin_ws/src/ublox/ublox_msgs/${idir}'.  Ask the maintainer 'Veronica Lane <vmlane@alum.mit.edu>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/husai/catkin_ws/devel/lib;/opt/ros/jade/lib)
...
set(ublox_msgs_EXPORTED_TARGETS "ublox_msgs_generate_messages_cpp;ublox_msgs_generate_messages_eus;ublox_msgs_generate_messages_lisp;ublox_msgs_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${ublox_msgs_dep}_FOUND)
      find_package(${ublox_msgs_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${ublox_msgs_dep} REQUIRED ${depend_list})
  endif()
