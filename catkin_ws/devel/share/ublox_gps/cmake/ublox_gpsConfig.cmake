...
if("TRUE" STREQUAL "TRUE")
  set(ublox_gps_SOURCE_PREFIX /home/husai/catkin_ws/src/ublox/ublox_gps)
  set(ublox_gps_DEVEL_PREFIX /home/husai/catkin_ws/devel)
  ...
  set(ublox_gps_INSTALL_PREFIX /home/husai/catkin_ws/install)
...
if(NOT "/home/husai/catkin_ws/src/ublox/ublox_gps/include " STREQUAL " ")
  set(ublox_gps_INCLUDE_DIRS "")
  set(_include_dirs "/home/husai/catkin_ws/src/ublox/ublox_gps/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'ublox_gps' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Gareth Cross <gcross.code@icloud.com>, Chao Qu <quchao@seas.upenn.edu>, Veronica Lane <vmlane@alum.mit.edu>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'ublox_gps' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/husai/catkin_ws/src/ublox/ublox_gps/${idir}'.  Ask the maintainer 'Gareth Cross <gcross.code@icloud.com>, Chao Qu <quchao@seas.upenn.edu>, Veronica Lane <vmlane@alum.mit.edu>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${ublox_gps_dep}_FOUND)
      find_package(${ublox_gps_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${ublox_gps_dep} REQUIRED ${depend_list})
  endif()
