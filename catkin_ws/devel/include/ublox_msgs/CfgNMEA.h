...
struct CfgNMEA_
{
  ...
  _reserved1_type reserved1;
    ...
    enum { CLASS_ID = 6u };
     ...
     enum { FILTER_TIME = 4u };
     enum { FILTER_DATE = 8u };
     enum { FILTER_GPS_ONLY = 16u };
     enum { FILTER_TRACK = 32u };
     enum { NMEA_VERSION_4_1 = 65u };
     enum { NMEA_VERSION_4_0 = 64u };
     enum { NMEA_VERSION_2_3 = 35u };
     enum { NMEA_VERSION_2_1 = 33u };
     enum { NUM_SV_UNLIMITED = 0u };
     enum { FLAGS_COMPAT = 1u };
     enum { FLAGS_CONSIDER = 2u };
     enum { FLAGS_LIMIT82 = 4u };
     enum { FLAGS_HIGH_PREC = 8u };
     enum { GNSS_TO_FILTER_GPS = 1u };
     enum { GNSS_TO_FILTER_SBAS = 2u };
     enum { GNSS_TO_FILTER_QZSS = 16u };
     enum { GNSS_TO_FILTER_GLONASS = 32u };
     enum { GNSS_TO_FILTER_BEIDOU = 64u };
     enum { SV_NUMBERING_STRICT = 0u };
     enum { SV_NUMBERING_EXTENDED = 1u };
     enum { MAIN_TALKER_ID_NOT_OVERRIDDEN = 0u };
     enum { MAIN_TALKER_ID_GP = 1u };
     enum { MAIN_TALKER_ID_GL = 2u };
     enum { MAIN_TALKER_ID_GN = 3u };
     enum { MAIN_TALKER_ID_GA = 4u };
     enum { MAIN_TALKER_ID_GB = 5u };
     enum { GSV_TALKER_ID_GNSS_SPECIFIC = 0u };
     enum { GSV_TALKER_ID_MAIN = 1u };
     enum { VERSION = 1u };
