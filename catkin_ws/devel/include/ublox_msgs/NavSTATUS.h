...
struct NavSTATUS_
{
  ...
  _msss_type msss;
    ...
    enum { CLASS_ID = 1u };
     ...
     enum { GPS_TIME_ONLY_FIX = 5u };
     enum { FLAGS_GPS_FIX_OK = 1u };
     enum { FLAGS_DIFF_SOLN = 2u };
     enum { FLAGS_WKNSET = 4u };
     enum { FLAGS_TOWSET = 8u };
     enum { FIX_STAT_DIFF_CORR_MASK = 1u };
     enum { FIX_STAT_MAP_MATCHING_MASK = 192u };
     enum { MAP_MATCHING_NONE = 0u };
     enum { MAP_MATCHING_VALID = 64u };
     enum { MAP_MATCHING_USED = 128u };
     enum { MAP_MATCHING_DR = 192u };
     enum { FLAGS2_PSM_STATE_MASK = 3u };
     enum { PSM_STATE_ACQUISITION = 0u };
     enum { PSM_STATE_TRACKING = 1u };
     enum { PSM_STATE_POWER_OPTIMIZED_TRACKING = 2u };
     enum { PSM_STATE_INACTIVE = 3u };
     enum { FLAGS2_SPOOF_DET_STATE_MASK = 24u };
     enum { SPOOF_DET_STATE_UNKNOWN = 0u };
     enum { SPOOF_DET_STATE_NONE = 8u };
     enum { SPOOF_DET_STATE_SPOOFING = 16u };
     enum { SPOOF_DET_STATE_MULTIPLE = 24u };
