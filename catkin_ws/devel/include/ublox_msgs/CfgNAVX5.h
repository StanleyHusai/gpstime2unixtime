...
struct CfgNAVX5_
{
  ...
  _useAdr_type useAdr;
    ...
    enum { CLASS_ID = 6u };
     enum { MESSAGE_ID = 35u };
     enum { MASK1_MIN_MAX = 4u };
     enum { MASK1_MIN_CNO = 8u };
     enum { MASK1_INITIAL_FIX_3D = 64u };
     enum { MASK1_WKN_ROLL = 512u };
     enum { MASK1_ACK_AID = 1024u };
     enum { MASK1_PPP = 8192u };
     enum { MASK1_AOP = 16384u };
     enum { MASK2_ADR = 64u };
     enum { MASK2_SIG_ATTEN_COMP_MODE = 128u };
