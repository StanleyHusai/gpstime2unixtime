...
struct CfgRST_
{
  ...
  _reserved1_type reserved1;
    ...
    enum { CLASS_ID = 6u };
     enum { MESSAGE_ID = 4u };
     enum { NAV_BBR_HOT_START = 0u };
     enum { NAV_BBR_WARM_START = 1u };
     enum { NAV_BBR_COLD_START = 65535u };
     enum { NAV_BBR_EPH = 1u };
     enum { NAV_BBR_ALM = 2u };
     enum { NAV_BBR_HEALTH = 4u };
     enum { NAV_BBR_KLOB = 8u };
     enum { NAV_BBR_POS = 16u };
     enum { NAV_BBR_CLKD = 32u };
     enum { NAV_BBR_OSC = 64u };
     enum { NAV_BBR_UTC = 128u };
     enum { NAV_BBR_RTC = 256u };
     enum { NAV_BBR_AOP = 32768u };
     enum { RESET_MODE_HW_IMMEDIATE = 0u };
     enum { RESET_MODE_SW = 1u };
     enum { RESET_MODE_GNSS = 2u };
     enum { RESET_MODE_HW_AFTER_SHUTDOWN = 4u };
     enum { RESET_MODE_GNSS_STOP = 8u };
     enum { RESET_MODE_GNSS_START = 9u };
