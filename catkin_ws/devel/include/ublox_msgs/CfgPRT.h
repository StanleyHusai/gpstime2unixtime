...
struct CfgPRT_
{
  ...
  _reserved1_type reserved1;
    ...
    enum { CLASS_ID = 6u };
     ...
     enum { MODE_DDC_SLAVE_ADDR_SHIFT = 1u };
     enum { MODE_DDC_SLAVE_ADDR_MASK = 254u };
     ...
     enum { MODE_SPI_SPI_MODE_CPOL = 4u };
     enum { MODE_SPI_SPI_MODE_CPHA = 2u };
     enum { MODE_SPI_FLOW_CONTROL = 64u };
     enum { MODE_SPI_FF_COUNT_SHIFT = 8u };
     enum { MODE_SPI_FF_COUNT_MASK = 16128u };
     enum { PROTO_UBX = 1u };
     enum { PROTO_NMEA = 2u };
     enum { PROTO_RTCM = 4u };
     enum { PROTO_RTCM3 = 32u };
     enum { FLAGS_EXTENDED_TX_TIMEOUT = 2u };
