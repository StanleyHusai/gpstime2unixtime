...
struct EsfMEAS_
{
  ...
  _calibTtag_type calibTtag;
    ...
    enum { CLASS_ID = 16u };
     enum { MESSAGE_ID = 2u };
     enum { FLAGS_TIME_MARK_SENT_MASK = 3u };
     enum { TIME_MARK_NONE = 0u };
     enum { TIME_MARK_EXT0 = 1u };
     enum { TIME_MARK_EXT = 2u };
     enum { FLAGS_TIME_MARK_EDGE = 4u };
     enum { FLAGS_CALIB_T_TAG_VALID = 8u };
     enum { DATA_FIELD_MASK = 16777215u };
     enum { DATA_TYPE_MASK = 1056964608u };
     enum { DATA_TYPE_SHIFT = 24u };
     enum { DATA_TYPE_NONE = 0u };
     enum { DATA_TYPE_Z_AXIS_GYRO = 5u };
     enum { DATA_TYPE_WHEEL_TICKS_FRONT_LEFT = 6u };
     enum { DATA_TYPE_WHEEL_TICKS_FRONT_RIGHT = 7u };
     enum { DATA_TYPE_WHEEL_TICKS_REAR_LEFT = 8u };
     enum { DATA_TYPE_WHEEL_TICKS_REAR_RIGHT = 9u };
     enum { DATA_TYPE_SINGLE_TICK = 10u };
     enum { DATA_TYPE_SPEED = 11u };
     enum { DATA_TYPE_GYRO_TEMPERATURE = 12u };
     enum { DATA_TYPE_GYRO_ANG_RATE_Y = 13u };
     enum { DATA_TYPE_GYRO_ANG_RATE_X = 14u };
     enum { DATA_TYPE_ACCELEROMETER_X = 16u };
     enum { DATA_TYPE_ACCELEROMETER_Y = 17u };
     enum { DATA_TYPE_ACCELEROMETER_Z = 18u };
