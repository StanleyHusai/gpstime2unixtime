...
struct CfgINF_Block_
{
  ...
  _infMsgMask_type infMsgMask;
    ...
    enum { PROTOCOL_ID_UBX = 0u };
     enum { PROTOCOL_ID_NMEA = 1u };
     enum { INF_MSG_ERROR = 1u };
     enum { INF_MSG_WARNING = 2u };
     enum { INF_MSG_NOTICE = 4u };
     enum { INF_MSG_TEST = 8u };
     enum { INF_MSG_DEBUG = 16u };
