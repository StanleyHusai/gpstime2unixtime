...
struct UpdSOS_Ack_
{
  ...
  _reserved1_type reserved1;
    ...
    enum { CLASS_ID = 9u };
     enum { MESSAGE_ID = 20u };
     enum { CMD_BACKUP_CREATE_ACK = 2u };
     enum { CMD_SYSTEM_RESTORED = 3u };
     enum { BACKUP_CREATE_NACK = 0u };
     enum { BACKUP_CREATE_ACK = 1u };
     enum { SYSTEM_RESTORED_RESPONSE_UNKNOWN = 0u };
     enum { SYSTEM_RESTORED_RESPONSE_FAILED = 1u };
     enum { SYSTEM_RESTORED_RESPONSE_RESTORED = 2u };
     enum { SYSTEM_RESTORED_RESPONSE_NOT_RESTORED = 3u };
