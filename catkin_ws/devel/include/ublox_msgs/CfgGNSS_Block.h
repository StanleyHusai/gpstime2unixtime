...
struct CfgGNSS_Block_
{
  ...
  _flags_type flags;
    ...
    enum { GNSS_ID_GPS = 0u };
     ...
     enum { GNSS_ID_IMES = 4u };
     enum { GNSS_ID_QZSS = 5u };
     enum { GNSS_ID_GLONASS = 6u };
     enum { RES_TRK_CH_GPS = 8u };
     enum { RES_TRK_CH_QZSS = 0u };
     enum { RES_TRK_CH_SBAS = 0u };
     enum { RES_TRK_CH_GLONASS = 8u };
     enum { MAX_TRK_CH_MAJOR_MIN = 4u };
     enum { MAX_TRK_CH_GPS = 16u };
     enum { MAX_TRK_CH_GLONASS = 14u };
     enum { MAX_TRK_CH_QZSS = 3u };
     enum { MAX_TRK_CH_SBAS = 3u };
     enum { FLAGS_ENABLE = 1u };
     enum { FLAGS_SIG_CFG_MASK = 16711680u };
     enum { SIG_CFG_GPS_L1CA = 65536u };
     enum { SIG_CFG_SBAS_L1CA = 65536u };
     enum { SIG_CFG_GALILEO_E1OS = 65536u };
     enum { SIG_CFG_BEIDOU_B1I = 65536u };
     enum { SIG_CFG_IMES_L1 = 65536u };
     enum { SIG_CFG_QZSS_L1CA = 65536u };
     enum { SIG_CFG_QZSS_L1SAIF = 262144u };
     enum { SIG_CFG_GLONASS_L1OF = 65536u };
