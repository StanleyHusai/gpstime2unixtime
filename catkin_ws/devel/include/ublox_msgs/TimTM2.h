...
struct TimTM2_
{
  ...
  _accEst_type accEst;
    ...
    enum { CLASS_ID = 13u };
     enum { MESSAGE_ID = 3u };
     enum { FLAGS_MODE_RUNNING = 1u };
     enum { FLAGS_RUN = 2u };
     enum { FLAGS_NEWFALLINGEDGE = 4u };
     enum { FLAGS_TIMEBASE_GNSS = 8u };
     enum { FLAGS_TIMEBASE_UTC = 16u };
     enum { FLAGS_UTC_AVAIL = 32u };
     enum { FLAGS_TIME_VALID = 64u };
     enum { FLAGS_NEWRISINGEDGE = 128u };
