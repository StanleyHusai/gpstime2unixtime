...
struct NavRELPOSNED_
{
  ...
  _flags_type flags;
    ...
    enum { CLASS_ID = 1u };
     ...
     enum { FLAGS_REL_POS_VALID = 4u };
     enum { FLAGS_CARR_SOLN_MASK = 24u };
     enum { FLAGS_CARR_SOLN_NONE = 0u };
     enum { FLAGS_CARR_SOLN_FLOAT = 8u };
     enum { FLAGS_CARR_SOLN_FIXED = 16u };
     enum { FLAGS_IS_MOVING = 32u };
     enum { FLAGS_REF_POS_MISS = 64u };
     enum { FLAGS_REF_OBS_MISS = 128u };
