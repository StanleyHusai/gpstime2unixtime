...
struct EsfINS_
{
  ...
  _zAccel_type zAccel;
    ...
    enum { CLASS_ID = 16u };
     enum { MESSAGE_ID = 21u };
     enum { BITFIELD0_VERSION = 255u };
     enum { BITFIELD0_X_ANG_RATE_VALID = 256u };
     enum { BITFIELD0_Y_ANG_RATE_VALID = 512u };
     enum { BITFIELD0_Z_ANG_RATE_VALID = 1024u };
     enum { BITFIELD0_X_ACCEL_VALID = 2048u };
     enum { BITFIELD0_Y_ACCEL_VALID = 4096u };
     enum { BITFIELD0_Z_ACCEL_VALID = 8192u };
