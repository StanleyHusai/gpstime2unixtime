...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_4BI.pack(_x.mode, _x.usage, _x.maxSBAS, _x.scanmode2, _x.scanmode1))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.mode, _x.usage, _x.maxSBAS, _x.scanmode2, _x.scanmode1,) = _struct_4BI.unpack(str[start:end])
      return self
