...
uint8 reserved              # Reserved"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_4BI4B.pack(_x.filter, _x.nmeaVersion, _x.numSV, _x.flags, _x.gnssToFilter, _x.svNumbering, _x.mainTalkerId, _x.gsvTalkerId, _x.reserved))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.filter, _x.nmeaVersion, _x.numSV, _x.flags, _x.gnssToFilter, _x.svNumbering, _x.mainTalkerId, _x.gsvTalkerId, _x.reserved,) = _struct_4BI4B.unpack(str[start:end])
      return self
