...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_4I2H4BI.pack(_x.pinSel, _x.pinBank, _x.pinDir, _x.pinVal, _x.noisePerMS, _x.agcCnt, _x.aStatus, _x.aPower, _x.flags, _x.reserved0, _x.usedMask))
      _x = self.VP
      # - if encoded as a list instead, serialize as bytes instead of string
      if type(_x) in [list, tuple]:
        buff.write(_struct_17B.pack(*_x))
      else:
        buff.write(_struct_17s.pack(_x))
      buff.write(_struct_B.pack(self.jamInd))
      _x = self.reserved1
      # - if encoded as a list instead, serialize as bytes instead of string
      if type(_x) in [list, tuple]:
      ...
      _x = self
      buff.write(_struct_3I.pack(_x.pinIrq, _x.pullH, _x.pullL))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.pinSel, _x.pinBank, _x.pinDir, _x.pinVal, _x.noisePerMS, _x.agcCnt, _x.aStatus, _x.aPower, _x.flags, _x.reserved0, _x.usedMask,) = _struct_4I2H4BI.unpack(str[start:end])
      start = end
      end += 17
      self.VP = str[start:end]
      start = end
      end += 1
      (self.jamInd,) = _struct_B.unpack(str[start:end])
      start = end
      end += 2
      ...
      (_x.pinIrq, _x.pullH, _x.pullL,) = _struct_3I.unpack(str[start:end])
      return self
