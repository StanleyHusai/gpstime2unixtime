...
uint8[4] reserved2     # Reserved"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_4BHhi2I4i7hH2ibBHh.pack(_x.type, _x.version, _x.svid, _x.reserved0, _x.iodNav, _x.deltaN, _x.m0, _x.e, _x.sqrtA, _x.omega0, _x.i0, _x.omega, _x.omegaDot, _x.iDot, _x.cuc, _x.cus, _x.crc, _x.crs, _x.cic, _x.cis, _x.toe, _x.af0, _x.af1, _x.af2, _x.sisaindexE1E5b, _x.toc, _x.bgdE1E5b))
      _x = self.reserved1
      ...
      _x = self
      buff.write(_struct_4B.pack(_x.healthE1B, _x.dataValidityE1B, _x.healthE5b, _x.dataValidityE5b))
      _x = self.reserved2
      # - if encoded as a list instead, serialize as bytes instead of string
      if type(_x) in [list, tuple]:
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.type, _x.version, _x.svid, _x.reserved0, _x.iodNav, _x.deltaN, _x.m0, _x.e, _x.sqrtA, _x.omega0, _x.i0, _x.omega, _x.omegaDot, _x.iDot, _x.cuc, _x.cus, _x.crc, _x.crs, _x.cic, _x.cis, _x.toe, _x.af0, _x.af1, _x.af2, _x.sisaindexE1E5b, _x.toc, _x.bgdE1E5b,) = _struct_4BHhi2I4i7hH2ibBHh.unpack(str[start:end])
      start = end
      end += 2
      ...
      (_x.healthE1B, _x.dataValidityE1B, _x.healthE5b, _x.dataValidityE5b,) = _struct_4B.unpack(str[start:end])
      start = end
      end += 4
