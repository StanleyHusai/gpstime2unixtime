...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_I2Bb2B.pack(_x.iTOW, _x.geo, _x.mode, _x.sys, _x.service, _x.cnt))
      _x = self.reserved0
      ...
      for val1 in self.sv:
        _x = val1
        buff.write(_struct_6BhHh.pack(_x.svid, _x.flags, _x.udre, _x.svSys, _x.svService, _x.reserved1, _x.prc, _x.reserved2, _x.ic))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.iTOW, _x.geo, _x.mode, _x.sys, _x.service, _x.cnt,) = _struct_I2Bb2B.unpack(str[start:end])
      start = end
      end += 3
      ...
      for i in range(0, length):
        ...
        (_x.svid, _x.flags, _x.udre, _x.svSys, _x.svService, _x.reserved1, _x.prc, _x.reserved2, _x.ic,) = _struct_6BhHh.unpack(str[start:end])
        self.sv.append(val1)
      return self
