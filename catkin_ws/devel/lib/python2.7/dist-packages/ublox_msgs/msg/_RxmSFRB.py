...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_2B.pack(_x.chn, _x.svid))
      buff.write(_struct_10I.pack(*self.dwrd))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.chn, _x.svid,) = _struct_2B.unpack(str[start:end])
      start = end
      end += 40
      self.dwrd = _struct_10I.unpack(str[start:end])
      return self
