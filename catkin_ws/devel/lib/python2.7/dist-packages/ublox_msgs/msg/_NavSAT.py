...
uint32 FLAGS_DO_CORR_USED = 4194304           # whether Range rate (Doppler) 
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_I2B.pack(_x.iTOW, _x.version, _x.numSvs))
      _x = self.reserved0
      ...
      for val1 in self.sv:
        _x = val1
        buff.write(_struct_3Bb2hI.pack(_x.gnssId, _x.svId, _x.cno, _x.elev, _x.azim, _x.prRes, _x.flags))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.iTOW, _x.version, _x.numSvs,) = _struct_I2B.unpack(str[start:end])
      start = end
      end += 2
      ...
      for i in range(0, length):
        ...
        (_x.gnssId, _x.svId, _x.cno, _x.elev, _x.azim, _x.prRes, _x.flags,) = _struct_3Bb2hI.unpack(str[start:end])
        self.sv.append(val1)
      return self
