...
# End of optional block"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_I2H.pack(_x.timeTag, _x.flags, _x.id))
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sI'%length
      buff.write(struct.pack(pattern, *self.calibTtag))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.timeTag, _x.flags, _x.id,) = _struct_I2H.unpack(str[start:end])
      start = end
      end += 4
      ...
      self.calibTtag = struct.unpack(pattern, str[start:end])
      return self
