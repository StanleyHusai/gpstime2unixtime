...
uint32 SIG_CFG_GLONASS_L1OF = 65536    # When gnssId is 6 (GLONASS)
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_4B.pack(_x.msgVer, _x.numTrkChHw, _x.numTrkChUse, _x.numConfigBlocks))
      length = len(self.blocks)
      buff.write(_struct_I.pack(length))
      for val1 in self.blocks:
        _x = val1
        buff.write(_struct_4BI.pack(_x.gnssId, _x.resTrkCh, _x.maxTrkCh, _x.reserved1, _x.flags))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.msgVer, _x.numTrkChHw, _x.numTrkChUse, _x.numConfigBlocks,) = _struct_4B.unpack(str[start:end])
      start = end
      end += 4
      ...
      for i in range(0, length):
        ...
        (_x.gnssId, _x.resTrkCh, _x.maxTrkCh, _x.reserved1, _x.flags,) = _struct_4BI.unpack(str[start:end])
