...
uint32 FLAGS_REF_OBS_MISS = 128   # Set if extrapolated reference observations
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_2BHI3i3bB4I.pack(_x.version, _x.reserved0, _x.refStationId, _x.iTow, _x.relPosN, _x.relPosE, _x.relPosD, _x.relPosHPN, _x.relPosHPE, _x.relPosHPD, _x.reserved1, _x.accN, _x.accE, _x.accD, _x.flags))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.version, _x.reserved0, _x.refStationId, _x.iTow, _x.relPosN, _x.relPosE, _x.relPosD, _x.relPosHPN, _x.relPosHPE, _x.relPosHPD, _x.reserved1, _x.accN, _x.accE, _x.accD, _x.flags,) = _struct_2BHI3i3bB4I.unpack(str[start:end])
      return self
