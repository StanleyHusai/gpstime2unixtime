...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_IihbBI.pack(_x.iTOW, _x.fTOW, _x.week, _x.leapS, _x.valid, _x.tAcc))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.iTOW, _x.fTOW, _x.week, _x.leapS, _x.valid, _x.tAcc,) = _struct_IihbBI.unpack(str[start:end])
      return self
