...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_2BH3i3bB3I.pack(_x.version, _x.reserved1, _x.flags, _x.ecefXOrLat, _x.ecefYOrLon, _x.ecefZOrAlt, _x.ecefXOrLatHP, _x.ecefYOrLonHP, _x.ecefZOrAltHP, _x.reserved2, _x.fixedPosAcc, _x.svinMinDur, _x.svinAccLimit))
      _x = self.reserved3
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.version, _x.reserved1, _x.flags, _x.ecefXOrLat, _x.ecefYOrLon, _x.ecefZOrAlt, _x.ecefXOrLatHP, _x.ecefYOrLonHP, _x.ecefZOrAltHP, _x.reserved2, _x.fixedPosAcc, _x.svinMinDur, _x.svinAccLimit,) = _struct_2BH3i3bB3I.unpack(str[start:end])
      start = end
      end += 8
