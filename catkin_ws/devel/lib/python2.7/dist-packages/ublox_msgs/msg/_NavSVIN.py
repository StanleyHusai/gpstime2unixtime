...
uint8[2] reserved3      # Reserved"""
  ...
  def serialize(self, buff):
    ...
    """
    try:
      buff.write(_struct_B.pack(self.version))
      _x = self.reserved0
      ...
      _x = self
      buff.write(_struct_2I3i3bB2I2B.pack(_x.iTOW, _x.dur, _x.meanX, _x.meanY, _x.meanZ, _x.meanXHP, _x.meanYHP, _x.meanZHP, _x.reserved1, _x.meanAcc, _x.obs, _x.valid, _x.active))
      _x = self.reserved3
      # - if encoded as a list instead, serialize as bytes instead of string
      if type(_x) in [list, tuple]:
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.version,) = _struct_B.unpack(str[start:end])
      start = end
      end += 3
      ...
      (_x.iTOW, _x.dur, _x.meanX, _x.meanY, _x.meanZ, _x.meanXHP, _x.meanYHP, _x.meanZHP, _x.reserved1, _x.meanAcc, _x.obs, _x.valid, _x.active,) = _struct_2I3i3bB2I2B.unpack(str[start:end])
      start = end
      end += 2
