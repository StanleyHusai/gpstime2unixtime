...
class CfgPRT(genpy.Message):
  _md5sum = "a4f010a61091571f886628b406ed3edb"
...
"""
  ...
  __slots__ = ['portID','reserved0','txReady','mode','baudRate','inProtoMask','outProtoMask','flags','reserved1']
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_2BH2I4H.pack(_x.portID, _x.reserved0, _x.txReady, _x.mode, _x.baudRate, _x.inProtoMask, _x.outProtoMask, _x.flags, _x.reserved1))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.portID, _x.reserved0, _x.txReady, _x.mode, _x.baudRate, _x.inProtoMask, _x.outProtoMask, _x.flags, _x.reserved1,) = _struct_2BH2I4H.unpack(str[start:end])
      return self
