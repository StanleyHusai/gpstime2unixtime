...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_I3iI.pack(_x.iTOW, _x.ecefVX, _x.ecefVY, _x.ecefVZ, _x.sAcc))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.iTOW, _x.ecefVX, _x.ecefVY, _x.ecefVZ, _x.sAcc,) = _struct_I3iI.unpack(str[start:end])
      return self
