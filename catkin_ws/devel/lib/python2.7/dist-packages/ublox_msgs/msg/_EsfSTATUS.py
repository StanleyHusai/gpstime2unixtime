...
uint8 faults        # Sensor faults (see graphic below)"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_IB.pack(_x.iTOW, _x.version))
      _x = self.reserved1
      ...
      buff.write(_struct_B.pack(self.fusionMode))
      _x = self.reserved2
      # - if encoded as a list instead, serialize as bytes instead of string
      if type(_x) in [list, tuple]:
      ...
      buff.write(_struct_B.pack(self.numSens))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.iTOW, _x.version,) = _struct_IB.unpack(str[start:end])
      start = end
      end += 7
      self.reserved1 = str[start:end]
      start = end
      end += 1
      (self.fusionMode,) = _struct_B.unpack(str[start:end])
      start = end
      end += 2
      self.reserved2 = str[start:end]
      start = end
      end += 1
      (self.numSens,) = _struct_B.unpack(str[start:end])
      start = end
      end += 4
