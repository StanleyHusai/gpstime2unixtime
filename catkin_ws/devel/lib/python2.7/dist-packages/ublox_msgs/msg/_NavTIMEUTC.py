...
uint8 UTC_STANDARD_UNKNOWN = 240"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_2IiH6B.pack(_x.iTOW, _x.tAcc, _x.nano, _x.year, _x.month, _x.day, _x.hour, _x.min, _x.sec, _x.valid))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.iTOW, _x.tAcc, _x.nano, _x.year, _x.month, _x.day, _x.hour, _x.min, _x.sec, _x.valid,) = _struct_2IiH6B.unpack(str[start:end])
      return self
