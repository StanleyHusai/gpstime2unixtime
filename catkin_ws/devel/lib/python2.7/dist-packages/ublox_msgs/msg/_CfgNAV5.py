...
uint8[5] reserved2      # Reserved"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_H2BiIbB4H4B.pack(_x.mask, _x.dynModel, _x.fixMode, _x.fixedAlt, _x.fixedAltVar, _x.minElev, _x.drLimit, _x.pDop, _x.tDop, _x.pAcc, _x.tAcc, _x.staticHoldThresh, _x.dgnssTimeOut, _x.cnoThreshNumSvs, _x.cnoThresh))
      _x = self.reserved1
      ...
      _x = self
      buff.write(_struct_HB.pack(_x.staticHoldMaxDist, _x.utcStandard))
      _x = self.reserved2
      # - if encoded as a list instead, serialize as bytes instead of string
      if type(_x) in [list, tuple]:
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.mask, _x.dynModel, _x.fixMode, _x.fixedAlt, _x.fixedAltVar, _x.minElev, _x.drLimit, _x.pDop, _x.tDop, _x.pAcc, _x.tAcc, _x.staticHoldThresh, _x.dgnssTimeOut, _x.cnoThreshNumSvs, _x.cnoThresh,) = _struct_H2BiIbB4H4B.unpack(str[start:end])
      start = end
      end += 2
      ...
      (_x.staticHoldMaxDist, _x.utcStandard,) = _struct_HB.unpack(str[start:end])
      start = end
      end += 5
