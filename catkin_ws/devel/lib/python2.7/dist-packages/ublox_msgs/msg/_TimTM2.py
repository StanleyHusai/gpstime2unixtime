...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_2B3H5I.pack(_x.ch, _x.flags, _x.risingEdgeCount, _x.wnR, _x.wnF, _x.towMsR, _x.towSubMsR, _x.towMsF, _x.towSubMsF, _x.accEst))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.ch, _x.flags, _x.risingEdgeCount, _x.wnR, _x.wnF, _x.towMsR, _x.towSubMsR, _x.towMsF, _x.towSubMsF, _x.accEst,) = _struct_2B3H5I.unpack(str[start:end])
      return self
