...
# End of repeated block"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_8B.pack(_x.gnssId, _x.svId, _x.reserved0, _x.freqId, _x.numWords, _x.chn, _x.version, _x.reserved1))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.gnssId, _x.svId, _x.reserved0, _x.freqId, _x.numWords, _x.chn, _x.version, _x.reserved1,) = _struct_8B.unpack(str[start:end])
      start = end
      end += 4
