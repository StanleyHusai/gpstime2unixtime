...
float32 scale         # Scale change [ppm]
  ...
  def serialize(self, buff):
    ...
    """
    try:
      buff.write(_struct_H.pack(self.datumNum))
      _x = self.datumName
      ...
      _x = self
      buff.write(_struct_2d7f.pack(_x.majA, _x.flat, _x.dX, _x.dY, _x.dZ, _x.rotX, _x.rotY, _x.rotZ, _x.scale))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.datumNum,) = _struct_H.unpack(str[start:end])
      start = end
      end += 6
      ...
      (_x.majA, _x.flat, _x.dX, _x.dY, _x.dZ, _x.rotX, _x.rotY, _x.rotZ, _x.scale,) = _struct_2d7f.unpack(str[start:end])
      return self
