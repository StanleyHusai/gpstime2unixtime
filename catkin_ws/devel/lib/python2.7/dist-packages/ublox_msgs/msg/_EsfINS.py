...
int32 zAccel          # Compensated z-axis acceleration (gravity-free) [mg]"""
  ...
  def serialize(self, buff):
    ...
    """
    try:
      buff.write(_struct_I.pack(self.bitfield0))
      _x = self.reserved1
      ...
      _x = self
      buff.write(_struct_I6i.pack(_x.iTOW, _x.xAngRate, _x.yAngRate, _x.zAngRate, _x.xAccel, _x.yAccel, _x.zAccel))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.bitfield0,) = _struct_I.unpack(str[start:end])
      start = end
      end += 4
      ...
      (_x.iTOW, _x.xAngRate, _x.yAngRate, _x.zAngRate, _x.xAccel, _x.yAccel, _x.zAccel,) = _struct_I6i.unpack(str[start:end])
      return self
