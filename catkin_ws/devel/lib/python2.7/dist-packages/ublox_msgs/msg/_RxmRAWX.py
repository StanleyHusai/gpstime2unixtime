...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_dHb3B.pack(_x.rcvTOW, _x.week, _x.leapS, _x.numMeas, _x.recStat, _x.version))
      _x = self.reserved1
      ...
      for val1 in self.meas:
        _x = val1
        buff.write(_struct_2df4BHb5B.pack(_x.prMes, _x.cpMes, _x.doMes, _x.gnssId, _x.svId, _x.reserved0, _x.freqId, _x.locktime, _x.cno, _x.prStdev, _x.cpStdev, _x.doStdev, _x.trkStat, _x.reserved1))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.rcvTOW, _x.week, _x.leapS, _x.numMeas, _x.recStat, _x.version,) = _struct_dHb3B.unpack(str[start:end])
      start = end
      end += 2
      ...
      for i in range(0, length):
        ...
        (_x.prMes, _x.cpMes, _x.doMes, _x.gnssId, _x.svId, _x.reserved0, _x.freqId, _x.locktime, _x.cno, _x.prStdev, _x.cpStdev, _x.doStdev, _x.trkStat, _x.reserved1,) = _struct_2df4BHb5B.unpack(str[start:end])
