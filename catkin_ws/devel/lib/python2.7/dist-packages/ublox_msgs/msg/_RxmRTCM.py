...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_2B.pack(_x.version, _x.flags))
      _x = self.reserved0
      ...
      _x = self
      buff.write(_struct_2H.pack(_x.refStation, _x.msgType))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.version, _x.flags,) = _struct_2B.unpack(str[start:end])
      start = end
      end += 2
      ...
      (_x.refStation, _x.msgType,) = _struct_2H.unpack(str[start:end])
      return self
