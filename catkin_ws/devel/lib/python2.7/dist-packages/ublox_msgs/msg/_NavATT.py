...
uint32 accHeading         # Vehicle heading accuracy [deg / 1e-5]"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_3i3I.pack(_x.roll, _x.pitch, _x.heading, _x.accRoll, _x.accPitch, _x.accHeading))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.roll, _x.pitch, _x.heading, _x.accRoll, _x.accPitch, _x.accHeading,) = _struct_3i3I.unpack(str[start:end])
      return self
