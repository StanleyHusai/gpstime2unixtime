...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_ih2B.pack(_x.iTOW, _x.week, _x.numVis, _x.numSV))
      length = len(self.sv)
      buff.write(_struct_I.pack(length))
      for val1 in self.sv:
        _x = val1
        buff.write(_struct_2BhbB.pack(_x.svid, _x.svFlag, _x.azim, _x.elev, _x.age))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.iTOW, _x.week, _x.numVis, _x.numSV,) = _struct_ih2B.unpack(str[start:end])
      start = end
      end += 4
      ...
      for i in range(0, length):
        ...
        (_x.svid, _x.svFlag, _x.azim, _x.elev, _x.age,) = _struct_2BhbB.unpack(str[start:end])
        self.sv.append(val1)
      return self
