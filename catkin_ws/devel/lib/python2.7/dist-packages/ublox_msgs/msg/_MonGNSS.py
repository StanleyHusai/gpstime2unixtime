...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_5B.pack(_x.version, _x.supported, _x.defaultGnss, _x.enabled, _x.simultaneous))
      _x = self.reserved1
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.version, _x.supported, _x.defaultGnss, _x.enabled, _x.simultaneous,) = _struct_5B.unpack(str[start:end])
      start = end
      end += 3
