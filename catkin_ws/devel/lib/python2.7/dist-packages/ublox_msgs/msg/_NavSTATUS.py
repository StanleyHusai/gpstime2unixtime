...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_I4B2I.pack(_x.iTOW, _x.gpsFix, _x.flags, _x.fixStat, _x.flags2, _x.ttff, _x.msss))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.iTOW, _x.gpsFix, _x.flags, _x.fixStat, _x.flags2, _x.ttff, _x.msss,) = _struct_I4B2I.unpack(str[start:end])
      return self
