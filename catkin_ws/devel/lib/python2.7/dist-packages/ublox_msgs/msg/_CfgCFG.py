...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_3IB.pack(_x.clearMask, _x.saveMask, _x.loadMask, _x.deviceMask))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.clearMask, _x.saveMask, _x.loadMask, _x.deviceMask,) = _struct_3IB.unpack(str[start:end])
      return self
